...
import { Typography, Box, Button, Backdrop, Link } from "@material-ui/core";
function UsingCreditsModalRepostJob() {
  ...
  return (
    <Box component="div" className="modalcontmid2 text-center">
      ...
      <Box component="div" className="maincontjobpost">
        ...
        <Typography variant="span" className="font16 block mb-2 fontweight500">
          Available Credits : 100.
        </Typography>
        <Typography variant="span" className="mb-2 font16 block fontweight500">
          To Be Used :{" "}
...
export default UsingCreditsModalRepostJob;
