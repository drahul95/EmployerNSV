    ...
    return(
          ...
          <Box component="div" className="modalcontmid2 text-center">
            ...
            <Box component="div" className="maincontjobpost">
              ...
              >
                You will be using
                <Typography variant="span" className="fontweight700 me-1 ms-1 font16">
                  80
                </Typography>
                credits for the Invite(s)
              </Typography>
              <Typography variant="span" className="font16 block mb-1 fontweight500">
                Available Credits : 100.
              </Typography>
              <Typography variant="span" className="mb-1 font16 block fontweight500">
                To Be Used : <Typography variant="span" className="fontweight700 me-1 ms-1 font16">
                  80
                </Typography>.
              </Typography>
              <Typography variant="span" className="font14 italic block mb-1">
