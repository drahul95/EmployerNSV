...
function UsingCreditsModalInsufficient() {
    ...
    <Box component="div" className="modalcontmid2 text-center">
      <Box component="div" className="dis_flex">
        <Box component="div" className="marginautoright">
          <Button
            className="btn-close ms-3 bottom-4"
            onClick={(e) => {
              handlepostjobCloseInsufficient();
            }}
      ...
      >
        Seems like you do not sufficient credits remaining to invite the
        selected candidate(s). Click below to get more credits.
      </Typography>
...
export default UsingCreditsModalInsufficient;
const ClosegreyBtn = () => {
  return (
    <svg
