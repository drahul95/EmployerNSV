...
function ApplicationSavedList(props) {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <Fade in={openmodalunlockmodal}>
                <Box
                  component="div"
                  className="modalcontsmall pt-4 text-center"
                >
                  <UnlockedIcon />
                  <Typography
                    variant="span"
                  ...
                  <Box component="div" className="maincontjobpost">
                    ...
                    <Typography
                      variant="span"
                      className="font14 italic block mb-3"
                    >
            ...
            >
              <Fade in={openmodalUnlockedSuccess}>
                <Box
                  component="div"
                  className="modalcontsmall px-20 text-center"
                >
                        ...
                        >
                          <Fade in={openProfileModal}>
                            <div className="modalcontsmall">
                              <DownloadOrange />
                              <Typography variant="h6">
                                Are you sure you want to download the candidate?
                              </Typography>
                              <Box
                                component="div"
      ...
      <Box component="div" className="botdiv dis_flex">
        ...
        <Box component="div" className="optdiv marginautoright">
          <Box
            component="div"
