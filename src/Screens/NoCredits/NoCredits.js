  ...
  return (
    <Box component="div" className="modalcontsmall px-20 text-center">
      ...
      <Box component="div" className="maincontjobpost">
        ...
        >
          You do not have enough credits to post a Job for X Locations
        </Typography>
        <Typography
          variant="span"
        ...
        <Typography
          variant="span"
          className="font14 block text-center mb-3 line-height-1-5"
        >
          Credits To Be Used (8*15): 120
        </Typography>
        <Box component="div" className="buttonareadiv">
          <Button
